...
|--------|-----------|---------------------|----------------|---------------|
| MAE    | 23.0056 | 23.0136 | 30.3065 | 24.1% |
| RMSE   | 26.8391 | 26.875 | 37.2437 | 27.9% |
| R2     | -0.0025 | -0.0057 | -0.9305 | - |

## RAM Prediction — Model Comparison

| Metric | LSTM (DL) | Random Forest (ML) | Naive Baseline | LSTM vs Naive |
|--------|-----------|---------------------|----------------|---------------|
| MAE    | 22.5876 | 22.6491 | 29.264 | 22.8% |
| RMSE   | 26.1152 | 26.1806 | 36.2601 | 28.0% |
| R2     | -0.0059 | -0.0105 | -0.9392 | - |
